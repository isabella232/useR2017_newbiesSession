...
* dare to approach people/speakers during conference
     ...
     + poster session: more informal
* move of your comfort zone
* attend to sessions of interest: skip sessions for networking
     
## Take it back home

* take notes: 
    + presenter, topic(s), new ideas/packages
    + bloc-note in conference bag
* share conference insights with colleagues
* slides available after conference in conference website
* videos by Microsoft
...
* Belgium cities: [Brussels](https://visit.brussels/en),
  [Antwerpen](http://www.visitantwerpen.be/en),
...
<br>
 ...
 <img src="./images/useR2017_logo.png" alt="Smiley face" height="150" width="700"> 
